...
func TestFetchTarball(t *testing.T) {
	...
	archive := ocitest.FeatureArchive(t, `{"id": "tarred", "version": "2.0.0"}`, true)
...
func TestFetchTarball_FollowsSecureRedirect(t *testing.T) {
	...
	archive := ocitest.FeatureArchive(t, `{"id": "redirected"}`, true)
	srv := httptest.NewTLSServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestFetchTarball_RefusesInsecureRedirect(t *testing.T) {
	...
	archive := ocitest.FeatureArchive(t, `{"id": "downgraded"}`, true)
...
func TestFetchOCI(t *testing.T) {
	...
	ocitest.PushFeature(t, host, "devcontainers/features/node", "1",
		ocitest.FeatureArchive(t, `{"id": "node", "version": "1.2.3"}`, false), false)
...
func TestFetchOCI_ThroughIndex(t *testing.T) {
	...
	host := ocitest.Registry(t)
	ocitest.PushFeature(t, host, "devcontainers/features/go", "1",
		ocitest.FeatureArchive(t, `{"id": "go"}`, false), true)
