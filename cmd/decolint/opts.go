...
type Options struct {
	...
	ListRules bool
	// Explain, when non-empty, is the ID of the rule to describe in full; the program prints its
...
func parseOptions(args []string, output io.Writer) (Options, error) {
	...
	fs.StringVar(&opts.Explain, "explain", "", "print what the rule with this ID checks, why, and where it is documented, then exit")
